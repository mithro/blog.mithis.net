...
{% capture day5_err %}ERROR:Place - Constraint Resolved NO placeable site for hdmiMatri_Comp/dvi_rx1/ioclk_buf issue{% endcapture %}
- Fought more with
  {% include bare-pre.html content=day5_err inline=true %}
