...
- [nstx](http://thomer.com/howtos/nstx.html) or [iodine](http://code.kryo.se/iodine/), tunneling over DNS
- [ssh](http://en.wikipedia.org/wiki/Secure_Shell), tunneling over ssh
