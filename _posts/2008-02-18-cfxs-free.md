...
{% capture cfxs_svn %}svn co http://verbal.mithis.com/svn/cfxs/trunk cfxs{% endcapture %}
{% include bare-pre.html blockquote=true content=cfxs_svn %}

So why not check it out and build your own? I have some left over components which I’m happy to dole out if you agree to actually use them in a useful way. Just [send me an email](mailto:mithro@mithis.com).
